...
Seven libFuzzer targets live in `tests/fuzz/`: the protocol parsers (`fuzz_command_frame`,
...
threads are involved). Each target has a seed corpus in `tests/fuzz/corpus/<target>/`,
