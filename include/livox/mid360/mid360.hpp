...
//
// v0.1 exposes the pure protocol layer only (no sockets). The device/session layer
// (discovery, parameter configuration, state machine, receive threads) lands in phase 2.
#pragma once
