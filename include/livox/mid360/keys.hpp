...
enum class ImuGyroRange : std::uint8_t {
  k2000dps = 0, k1000dps = 1, k500dps = 2, k250dps = 3,
  k125dps = 4, k62_5dps = 5, k31_25dps = 6, k15_625dps = 7,
};
...
[[nodiscard]] std::expected<std::uint16_t, KeyError> decode_u16(std::span<const std::byte>) noexcept;
[[nodiscard]] std::expected<std::uint32_t, KeyError> decode_u32(std::span<const std::byte>) noexcept;
[[nodiscard]] std::expected<std::int32_t, KeyError> decode_i32(std::span<const std::byte>) noexcept;
[[nodiscard]] std::expected<std::uint64_t, KeyError> decode_u64(std::span<const std::byte>) noexcept;
